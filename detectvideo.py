...
from helping_functions import get_human_box_detection
...
flags.DEFINE_string('video', './input_video/WebCamSample1920x1080.mp4', 'path to input video')
...
def main(_argv):
    ...
    while True:
        ...
        for i,items in enumerate(array_boxes_detected):
            ...
            cv2.rectangle(original_frame,(second_point,first_point),(fourth_point,third_point),COLOR_RED,2)
        curr_time = time.time()
